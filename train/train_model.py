...
def build_model(width,height,n_len, num_channels):
...
def train(args):
    ...
    input_tensor, y_pred = build_model(args.img_size[0],args.img_size[1], label_len, args.num_channels)
...
def export(args):
    ...
    """
    input_tensor, y_pred = build_model(164 , 48 , 6, args.num_channels)
...
def main ():
    ...
    parser_export.add_argument('-pre', help='pre trained weight file', default='')
